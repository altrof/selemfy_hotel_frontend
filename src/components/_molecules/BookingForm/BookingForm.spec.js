...
describe('BookingForm', () => {
    ...
    it("has default amount value 1 for `Adults`", () => {
        ...
        expect(screen.getByText('Adults').nextElementSibling.children[1]).toHaveTextContent("1");
    });

    it("has default amount value 0 for `Children`", () => {
        render(BookingForm);

        expect(screen.getByText('Children').nextElementSibling.children[1]).toHaveTextContent("0");
    });
