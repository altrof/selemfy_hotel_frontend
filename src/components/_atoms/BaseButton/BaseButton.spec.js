...
describe('BaseButton.vue', () => {
    ...
    it('renders properly', () => {
        render(BaseButton);
        expect(getBaseButtonElement())
        .toHaveClass('hover:bg-blue-500 text-gray-700 hover:text-white px-5 border-2 border-gray-800 hover:border-transparent rounded mx-0.5');
    })
